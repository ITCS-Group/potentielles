export const fr = {
  faq: {
    ...
    questions: {
      ...
      trainingAnswer: "Les formations sont accessibles dans la section 'Ressources'. Elles couvrent des sujets essentiels comme la gestion financière, le marketing digital, et le développement commercial.",
