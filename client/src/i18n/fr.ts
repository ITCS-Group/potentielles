...
export const fr = {
  ...
  admin: {
    ...
    overview: {
      ...
      description: "Gérer les utilisateurs, les projets et les paramètres de la plateforme"
    }
  },
  mentors: {
  ...
  resources: {
    ...
    videoTraining: {
      ...
      description: "Vidéos éducatives sur la gestion d'entreprise et l'entrepreneuriat"
    }
  },
  faq: {
    ...
    questions: {
      ...
      accountAnswer: "Cliquez sur le bouton 'S'inscrire' en haut de la page. Remplissez le formulaire avec vos informations personnelles et sélectionnez votre rôle.",
